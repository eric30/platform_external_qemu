...
void goldfish_bt_set_remote_property(char *address, char *property, char *value)
{
    ABluetooth bt = &_android_bluetooth[0];
    bt_set_remote_property(bt->hci, address, property, value);
}
